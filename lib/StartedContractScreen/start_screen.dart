...
class StartContractScreen extends StatefulWidget
{
  @override
  State<StartContractScreen> createState() => _StartContractScreen();
}



class _StartContractScreen extends State<StartContractScreen> {
  @override
